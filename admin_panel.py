...
# ====================== Users/Employees ======================
    ...
    # (Your full Users/Employees code from previous version)
    ...
    # ... (rest of the Users tab code remains as you had it earlier) ...
    st.info("Users management section - full code retained from your previous version.")
...
# ====================== Job Categories ======================
    ...
    with tab2:
        ...
        st.info(f" Icon upload limit: **{MAX_ICON_SIZE_MB}MB**. Icons are auto-compressed.")
            ...
            if submitted:
                if not name.strip():
                    ...
                    if len(raw_bytes) > MAX_ICON_BYTES:
                        ...
                        try:
                            icon_url, size_bytes = compress_image_to_base64(raw_bytes, icon_file.type)
                            ...
                            st.success(f" Category '{name}' added successfully! (Icon: {size_bytes/1024:.1f} KB)")
                            st.cache_data.clear()
                            st.balloons()
...
# ====================== Settings ======================
    ...
    st.success("✅ Icon saving logic fixed for new categories")
    st.info("New categories now properly save both `icon` and `iconUrl` fields.")
